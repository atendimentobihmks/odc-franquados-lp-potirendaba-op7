...
export const UNITS_DATA: Record<string, UnitData> = {
  potirendaba: {
    ...
    name: 'Potirendaba',
    phone: '(17) 99194-0409',
    whatsapp: '5517991940409',
    whatsappMessage: 'Olá! Gostaria de agendar uma consulta de avaliação na OdontoCompany Potirendaba.',
    instagramUrl: 'https://www.instagram.com/odontocompanypotirendaba/',
    facebookUrl: 'https://www.facebook.com/odontocompanypotirendaba/',
    croCl: 'CRO-SP 133.180',
    address: {
      street: 'Rua Senador Barros Penteado',
      number: '804',
      neighborhood: 'Centro',
      city: 'Potirendaba',
      state: 'SP',
    ...
    dentists: [
      {
        ...
        cro: 'CRO-SP 133180',
        photoUrl: '/images/dentistas/dra-gabriell-caroline.webp'
      }
    ],
    testimonials: [
      {
        ...
        rating: 5,
        text: 'Excelente atendimento na OdontoCompany Potirendaba! A clínica é muito bonita, os profissionais super atenciosos e o tratamento de implante foi super tranquilo.',
        treatment: 'Implante Dentário'
      },
      {
        name: 'Mariana Silveira',
        rating: 5,
        text: 'Coloquei meu aparelho na OdontoCompany Potirendaba e já vejo muita diferença no meu sorriso. Facilidade no pagamento e equipe maravilhosa!',
        treatment: 'Ortodontia'
      },
      {
        name: 'Luciana Ramos',
        rating: 5,
        text: 'Fiz clareamento e limpeza preventiva na unidade. Atendimento pontual, ambiente muito limpo e profissionais que passam muita segurança. Recomendo a todos de Potirendaba e região.',
